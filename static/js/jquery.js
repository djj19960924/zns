!(function(a, b) {
  ...
  function s(a, b) {
    if (b in a) return b;
    for (
      var c = b.charAt(0).toUpperCase() + b.slice(1), d = b, e = $b.length;
      e--;
  ...
  function x(a, b, c, d, e) {
    for (
      ...
      "margin" === c && (g += fb.css(a, c + Zb[f], !0, e)),
        d
          ? ("content" === c && (g -= fb.css(a, "padding" + Zb[f], !0, e)),
            "margin" !== c &&
              (g -= fb.css(a, "border" + Zb[f] + "Width", !0, e)))
          : ((g += fb.css(a, "padding" + Zb[f], !0, e)),
            "padding" !== c &&
              (g += fb.css(a, "border" + Zb[f] + "Width", !0, e)));
    return g;
  }
    ...
    return (
      c ||
        ...
        ("none" !== c && c) ||
          ...
          (b = (Qb[0].contentWindow || Qb[0].contentDocument).document),
  ...
  function I(a, b) {
    fb.each(b, function(b, c) {
      for (
        var d = (Gc[b] || []).concat(Gc["*"]), e = 0, f = d.length;
        f > e;
        e++
      )
  ...
  function L(a, c, d) {
    ...
    d.queue ||
      ...
      1 === a.nodeType &&
        ...
        ((d.overflow = [o.overflow, o.overflowX, o.overflowY]),
    ...
    for (e in c)
      if (((g = c[e]), Cc.exec(g))) {
        if (
          (delete c[e], (j = j || "toggle" === g), g === (r ? "hide" : "show"))
        ) {
    ...
    if ((h = q.length)) {
      (i = qb.get(a, "fxshow") || qb.access(a, "fxshow", {})),
        "hidden" in i && (r = i.hidden),
        j && (i.hidden = !r),
        r
          ? fb(a).show()
          : n.done(function() {
      ...
      for (e = 0; h > e; e++)
        (f = q[e]),
          (k = n.createTween(f, r ? i[f] : 0)),
          (p[f] = i[f] || fb.style(a, f)),
          f in i ||
            ((i[f] = k.start),
            r &&
              ((k.end = k.start),
              (k.start = "width" === f || "height" === f ? 1 : 0)));
    }
  }
  ...
  function N(a, b) {
    ...
    for (b = b ? 1 : 0; 4 > e; e += 2 - b)
      (c = Zb[e]), (d["margin" + c] = d["padding" + c] = a);
  ...
  (fb.fn = fb.prototype = {
      ...
      if ("string" == typeof a) {
        ...
        if (e[1]) {
          if (
            ...
            fb.merge(
              this,
              fb.parseHTML(e[1], c && c.nodeType ? c.ownerDocument || c : T, !0)
            ),
    ...
    (function(a, b) {
          ...
          if ((e = ub.exec(a)))
            if ((g = e[1])) {
              ...
              if (
                ...
                return bb.apply(c, b.getElementsByClassName(g)), c;
            }
          if (Q.qsa && (!K || !K.test(a))) {
            if (
              ((l = k = O),
      ...
      function j(a, c, d) {
        ...
        return d
          ? b
          : (e = a.getAttribute(c, "type" === c.toLowerCase() ? 1 : 2));
      }
      function k(a) {
        return function(b) {
          var c = b.nodeName.toLowerCase();
      ...
      function n(a, b) {
        ...
        for (h = a, i = [], j = A.preFilter; h; ) {
          (!c || (d = mb.exec(h))) &&
            (d && (h = h.slice(d[0].length) || h), i.push((e = []))),
            (c = !1),
            (d = nb.exec(h)) &&
              ((c = d.shift()),
              e.push({ value: c, type: d[0].replace(lb, " ") }),
              (h = h.slice(c.length)));
          for (f in A.filter)
            !(d = sb[f].exec(h)) ||
              (j[f] && !(d = j[f](d))) ||
        ...
        return (
          ...
          e(function(e, g, h, i) {
            var j,
              ...
              s = c ? (f || (e ? a : o || d) ? [] : g) : q;
            if ((c && c(q, s, h, i), d))
              for (j = r(s, n), d(j, [], h, i), k = j.length; k--; )
                (l = j[k]) && (s[n[k]] = !(q[n[k]] = l));
            if (e) {
              if (f || a) {
                if (f) {
        ...
        for (
          ...
          if ((c = A.relative[a[h].type])) k = [p(q(k), c)];
            ...
            if (((c = A.filter[a[h].type].apply(null, a[h].matches)), c[O])) {
              ...
              return s(
                h > 1 && q(k),
                h > 1 && o(a.slice(0, h - 1)).replace(lb, "$1"),
                c,
                d > h && t(a.slice(h, d)),
                e > d && t((a = a.slice(d))),
                e > d && o(a)
      ...
      function w(a, b, c, d) {
        ...
        if (!d && 1 === j.length) {
          if (
            ...
            if (
              ((b = (A.find.ID(g.matches[0].replace(yb, zb), b) || [])[0]), !b)
            )
              return c;
            a = a.slice(f.shift().value.length);
          }
          for (
            e = sb.needsContext.test(a) ? 0 : f.length;
            ...
            if (
              (i = A.find[h]) &&
              (d = i(
                g.matches[0].replace(yb, zb),
                (ob.test(f[0].type) && b.parentNode) || b
              ))
            ) {
              if ((f.splice(e, 1), (a = d.length && o(f)), !a))
                return bb.apply(c, d), c;
              break;
            }
        }
      ...
      var y,
        ...
        mb = new RegExp("^" + gb + "*," + gb + "*"),
        nb = new RegExp("^" + gb + "*([>+~]|" + gb + ")" + gb + "*"),
        ob = new RegExp(gb + "*[+~]"),
        pb = new RegExp("=" + gb + "*([^\\]'\"]*)" + gb + "*\\]", "g"),
        qb = new RegExp(kb),
        rb = new RegExp("^" + ib + "$"),
        sb = {
          ID: new RegExp("^#(" + hb + ")"),
      ...
      try {
        bb.apply(($ = cb.call(P.childNodes)), P.childNodes),
      ...
      (C = g.isXML = function(a) {
          ...
          return d !== H && 9 === d.nodeType && d.documentElement
            ? ((H = d),
              ...
              (A.find.TAG = Q.getElementsByTagName
                ? function(a, b) {
                    return typeof b.getElementsByTagName !== Y
              ...
              (A.find.CLASS =
                Q.getElementsByClassName &&
                function(a, b) {
                  return typeof b.getElementsByClassName !== Y && J
                    ? b.getElementsByClassName(a)
                    : void 0;
                }),
              (L = []),
              (K = []),
              (Q.qsa = c(d.querySelectorAll)) &&
                (f(function(a) {
                  (a.innerHTML =
              ...
              (N =
                c(I.contains) || I.compareDocumentPosition
                  ? function(a, b) {
              ...
              (X = I.compareDocumentPosition
                ? function(a, b) {
                    ...
                    return c
                      ? 1 & c ||
                        (!Q.sortDetached && b.compareDocumentPosition(a) === c)
                        ? a === d || N(P, a)
                          ? -1
                          : b === d || N(P, b)
                          ? 1
                          : F
                          ? db.call(F, a) - db.call(F, b)
                          : 0
                        : 4 & c
                        ? -1
                        : 1
        ...
        (g.matchesSelector = function(a, b) {
          if (
            ...
            (b = b.replace(pb, "='$1']")),
            !(!Q.matchesSelector || !J || (L && L.test(b)) || (K && K.test(b))))
          )
            try {
              var c = M.call(a, b);
              if (
        ...
        (g.uniqueSort = function(a) {
          var b,
            ...
            e = 0;
          if (
            ((W = !Q.detectDuplicates),
            (F = !Q.sortStable && a.slice(0)),
            a.sort(X),
            W)
          ) {
        ...
        (A = g.selectors = {
          ...
          preFilter: {
            ATTR: function(a) {
              return (
                (a[1] = a[1].replace(yb, zb)),
                (a[3] = (a[4] || a[5] || "").replace(yb, zb)),
                "~=" === a[2] && (a[3] = " " + a[3] + " "),
                a.slice(0, 4)
              );
            },
          ...
          filter: {
            ...
            CLASS: function(a) {
              ...
              return (
                b ||
                ((b = new RegExp("(^|" + gb + ")" + a + "(" + gb + "|$)")) &&
                  T(a, function(a) {
                    return b.test(
                      ("string" == typeof a.className && a.className) ||
                        (typeof a.getAttribute !== Y &&
          ...
          pseudos: {
            ...
            lang: e(function(a) {
              return (
                rb.test(a || "") || g.error("unsupported lang: " + a),
                (a = a.replace(yb, zb).toLowerCase()),
                function(b) {
                  var c;
                  do
                    if (
      ...
      (D = g.compile = function(a, b) {
        ...
        f(function(a) {
          if (null != a.getAttribute("disabled"))
            for (var b = eb.split("|"), c = b.length; c--; )
              A.attrHandle[b[c]] = i;
        }),
        (fb.find = g),
        (fb.expr = g.selectors),
        (fb.expr[":"] = fb.expr.pseudos),
        (fb.unique = g.uniqueSort),
        (fb.text = g.getText),
        (fb.isXMLDoc = g.isXML),
        (fb.contains = g.contains);
    })(a);
  var ob = {};
      ...
      remove: function(a, c) {
        ...
        if (c === b) this.cache[f] = {};
          ...
          fb.isArray(c)
            ...
            : c in g
            ? (e = [c])
            : ((e = fb.camelCase(c)), (e = e in g ? [e] : e.match(hb) || [])),
            (d = e.length);
          for (; d--; ) delete g[e[d]];
        }
      },
        ...
        if (a === b) {
          if (
            ...
            for (d = g.attributes; h < d.length; h++)
              (e = d[h].name),
                0 === e.indexOf("data-") &&
                  ((e = fb.camelCase(e.substring(5))), f(g, e, i[e]));
    ...
    toggleClass: function(a, b) {
      ...
      return fb.isFunction(a)
        ...
        : this.each(function() {
            if ("string" === c)
              for (
                var e, f = 0, g = fb(this), h = b, i = a.match(hb) || [];
                (e = i[f++]);
    ...
    fb.extend({
        ...
        if (a && 3 !== g && 8 !== g && 2 !== g)
          return typeof a.getAttribute === R
            ...
            : ((1 === g && fb.isXMLDoc(a)) ||
                ...
                (e =
                  fb.attrHooks[c] ||
                  (fb.expr.match.boolean.test(c) ? ub : tb))),
              d === b
      ...
      removeAttr: function(a, b) {
        ...
        if (f && 1 === a.nodeType)
          for (; (c = f[e++]); )
            (d = fb.propFix[c] || c),
              fb.expr.match.boolean.test(c) && (a[d] = !1),
              a.removeAttribute(c);
      },
      attrHooks: {
        type: {
  ...
  (fb.event = {
    ...
    fb.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, function(
      a,
      b
    ) {
      fb.event.special[a] = {
  ...
  fb.fn.extend({
    ...
    is: function(a) {
      return (
        ...
        ("string" == typeof a
          ? Db.test(a)
            ? fb(a, this.context).index(this[0]) >= 0
            : fb.filter(a, this).length > 0
    ...
    closest: function(a, b) {
      for (
        var c,
          ...
          e = this.length,
          f = [],
          g = Db.test(a) || "string" != typeof a ? fb(a, b || this.context) : 0;
        e > d;
        d++
      )
      ...
      function(a, b) {
        fb.fn[a] = function(c, d) {
          ...
          return (
            ...
            this.length > 1 &&
              (Eb[a] || fb.unique(e), "p" === a[0] && e.reverse()),
            this.pushStack(e)
          );
        };
      }
  ...
  (Ob.optgroup = Ob.option),
    (Ob.tbody = Ob.tfoot = Ob.colgroup = Ob.caption = Ob.col = Ob.thead),
    (Ob.th = Ob.td),
    fb.fn.extend({
      text: function(a) {
        return fb.access(
            ...
            for (
              ...
              (h = f[j]),
                Lb.test(h.type || "") &&
                  ...
                  (h.src
                    ? fb._evalUrl(h.src)
                    : fb.globalEval(h.textContent.replace(Nb, "")));
        }
        return this;
      }
    }),
    ...
    fb.extend({
            ...
            if ("object" === fb.type(e)) fb.merge(n, e.nodeType ? [e] : e);
              ...
              for (
                f = f || m.appendChild(b.createElement("div")),
                  g = (Gb.exec(e) || ["", ""])[1].toLowerCase(),
                  h = Ob[g] || Ob._default,
                  f.innerHTML = h[1] + e.replace(Fb, "<$1></$2>") + h[2],
                  j = h[0];
                j--;
      ...
      cleanData: function(a) {
        for (
          var b, c, d, e = a.length, f = 0, g = fb.event.special;
          e > f;
          f++
        ) {
          if (((c = a[f]), fb.acceptData(c) && (b = qb.access(c))))
            for (d in b.events)
              g[d] ? fb.event.remove(c, d) : fb.removeEvent(c, d, b.handle);
  ...
  fb.fn.extend({
    ...
    fb.each(["height", "width"], function(a, b) {
      fb.cssHooks[b] = {
        get: function(a, c, d) {
          return c
            ? 0 === a.offsetWidth && Rb.test(fb.css(a, "display"))
              ? fb.swap(a, Xb, function() {
                  return y(a, b, d);
                })
              : y(a, b, d)
            : void 0;
    ...
    fb(function() {
      fb.support.reliableMarginRight ||
        (fb.cssHooks.marginRight = {
          get: function(a, b) {
            return b
              ? fb.swap(a, { display: "inline-block" }, Pb, [a, "marginRight"])
              : void 0;
          }
        }),
          ...
          fb.each(["top", "left"], function(a, b) {
            fb.cssHooks[b] = {
              get: function(a, c) {
                return c
                  ? ((c = Pb(a, b)),
                    Ub.test(c) ? fb(a).position()[b] + "px" : c)
                  : void 0;
              }
            };
          });
      ...
      return this.map(function() {
        ...
        .filter(function() {
          ...
          return (
            this.name &&
            !fb(this).is(":disabled") &&
            dc.test(this.nodeName) &&
            !cc.test(a) &&
            (this.checked || !Jb.test(a))
          );
        })
        .map(function(a, b) {
          var c = fb(this).val();
    ...
    fb.extend({
      ...
      ajax: function(a, c) {
        ...
        (k = m.global),
          ...
          m.hasContent ||
            (m.data &&
              ((f = m.url += (hc.test(f) ? "&" : "?") + m.data), delete m.data),
            m.cache === !1 &&
              (m.url = jc.test(f)
                ? f.replace(jc, "$1_=" + gc++)
                : f + (hc.test(f) ? "&" : "?") + "_=" + gc++)),
  ...
  fb.ajaxSetup({
    ...
    fb.ajaxPrefilter("json jsonp", function(c, d, e) {
      ...
      return i || "jsonp" === c.dataTypes[0]
        ? ((f = c.jsonpCallback = fb.isFunction(c.jsonpCallback)
            ? c.jsonpCallback()
            : c.jsonpCallback),
          i
            ? (c[i] = c[i].replace(vc, "$1" + f))
            : c.jsonp !== !1 &&
              (c.url += (hc.test(c.url) ? "&" : "?") + c.jsonp + "=" + f),
  ...
  a.ActiveXObject &&
    ...
    (fb.support.cors = !!wc && "withCredentials" in wc),
    (fb.support.ajax = wc = !!wc),
      ...
      "*": [
        function(a, b) {
          ...
          if (f) {
            if (
              ((c = +f[2]),
              (d = f[3] || (fb.cssNumber[a] ? "" : "px")),
              "px" !== d && h)
            ) {
              h = fb.css(e.elem, a, !0) || c || 1;
              do (i = i || ".5"), (h /= i), fb.style(e.elem, a, h + d);
  ...
  (fb.Animation = fb.extend(J, {
    tweener: function(a, b) {
      ...
      for (var c, d = 0, e = a.length; e > d; d++)
        (c = a[d]), (Gc[c] = Gc[c] || []), Gc[c].unshift(b);
    },
      ...
      _default: {
        ...
        set: function(a) {
          fb.fx.step[a.prop]
            ? fb.fx.step[a.prop](a)
            : a.elem.style &&
              (null != a.elem.style[fb.cssProps[a.prop]] || fb.cssHooks[a.prop])
      ...
      stop: function(a, c, d) {
        ...
        return (
          ...
          this.each(function() {
            ...
            else for (c in g) g[c] && g[c].stop && Ec.test(c) && e(g[c]);
            for (c = f.length; c--; )
              f[c].elem !== this ||
                (null != a && f[c].queue !== a) ||
    ...
    fb.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function(
      c,
      d
    ) {
      var e = "pageYOffset" === d;
    ...
    fb.each({ Height: "height", Width: "width" }, function(a, c) {
      fb.each({ padding: "inner" + a, content: c, "": "outer" + a }, function(
        d,
        e
      ) {
